...
var canyon = _interopRequireWildcard(require("./sketches/canyon"));

var greenFields = _interopRequireWildcard(require("./sketches/greenFields"));

var tree = _interopRequireWildcard(require("./sketches/tree"));

var perlin = _interopRequireWildcard(require("./sketches/perlin"));
...
window.addEventListener("load", function () {
    ...
    var SketchList = React.createClass({
        ...
        render: function () {
            ...
            var sketches = this.props.sketches.map(function (sketch) {
                return React.createElement(Sketch, { key: sketch.key, sketch: sketch });
            });
            return React.createElement(
                "div",
                { className: "sketches" },
    ...
    var Sketches = React.createFactory(React.createClass({
        ...
        render: function () {
            /* jshint ignore:start */
            return React.createElement(SketchList, { sketches: sketches });
            /* jshint ignore:end */
        }
    }));
...
}).call(this,require("oMfpAn"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/sketches/canyon.js","/sketches")
...
}).call(this,require("oMfpAn"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/sketches/greenFields.js","/sketches")
...
}).call(this,require("oMfpAn"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/sketches/perlin.js","/sketches")
...
}).call(this,require("oMfpAn"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/sketches/tree.js","/sketches")
